...
export default function GlömtLösenordFamilj() {
  ...
  return (
    <AuthLayout title="Glömt lösenordet?" subtitle="Vi skickar en länk till din e-post">
      {sent ? (
        <div className="rounded-lg bg-(--teal-light) px-5 py-4 text-center">
          ...
          <p className="mt-1 text-sm text-(--text-mid)">
            Om {email} finns registrerat har vi skickat en länk för att återställa ditt lösenord.
          </p>
        </div>
      ) : (
      ...
      <div className="mt-6 text-center">
        <a href="/familj/logga-in" className="text-sm text-(--teal) hover:underline">
